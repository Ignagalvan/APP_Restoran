...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      ...
      { id: "tortilla", name: "Tortilla de papas", description: "Papa, chorizo colorado, huevo, cebolla y alioli.", price: "$13.500", ingredients: ["Papa", "Chorizo colorado", "Huevo", "Cebolla", "Alioli"], pairing: "Va muy bien con una cerveza roja." },
  ...
  },
  {
    ...
    items: [
      { id: "ojo-bife", section: "principales", name: "Ojo de bife con hueso", price: "$34.000", optionGroups: [garnishGroup] },
      { id: "bife-chorizo", section: "principales", name: "Bife de chorizo", price: "$34.000", optionGroups: [garnishGroup] },
      { id: "salmon", section: "principales", name: "Salmón rosado", price: "$37.000", optionGroups: [garnishGroup] },
      { id: "molleja-verdeo", section: "principales", name: "Molleja al verdeo", description: "Con puré de papas.", price: "$27.500", ingredients: ["Molleja", "Verdeo", "Puré de papas"], optionGroups: [garnishGroup] },
      ...
      { id: "pacu", section: "principales", name: "Pacú · Pesca del día", price: "$25.000", optionGroups: [garnishGroup] },
      ...
      { id: "risotto-gamberi", section: "principales", name: "Risotto ai gamberi", description: "Langostinos, arroz carnaroli y tinta de calamar.", price: "$27.000" },
      { id: "risotto-calabaza", section: "principales", name: "Risotto de calabaza asada", description: "Queso azul y nueces tostadas.", price: "$21.000", tags: ["Vegetariano"] },
      ...
      { id: "noquis-ricota", section: "pastas", name: "Cazuela de ñoquis de ricota y espinaca", price: "$19.000", optionGroups: [sauceGroup, extraSauceGroup] },
      { id: "noquis-papa", section: "pastas", name: "Cazuela de ñoquis de papa", price: "$16.000", optionGroups: [sauceGroup, extraSauceGroup] },
      ...
      { id: "sorrentinos-hongos", section: "pastas", name: "Sorrentinos de hongo de pino", price: "$23.000", optionGroups: [sauceGroup, extraSauceGroup] },
      ...
      { id: "sorrentinos-calabaza", section: "pastas", name: "Sorrentinos de calabaza", price: "$23.000", optionGroups: [sauceGroup, extraSauceGroup] },
      ...
      { id: "ravioles-espinaca", section: "pastas", name: "Ravioles de espinaca", price: "$23.000", optionGroups: [sauceGroup, extraSauceGroup] },

      { id: "pizza-clasica", section: "pizzas", name: "Clásica", description: "Mozzarella, salsa de tomate, orégano y olivas verdes.", price: "$18.000" },
      { id: "pizza-napolitana", section: "pizzas", name: "Napolitana", description: "Mozzarella, tomate, aceite de ajo y olivas verdes.", price: "$20.000" },
      { id: "pizza-burrata", section: "pizzas", name: "Burrata", description: "Mozzarella, salsa de tomate, burrata, pesto, albahaca y olivas verdes.", price: "$27.000", tags: ["Recomendado"] },
      { id: "pizza-fugazzeta", section: "pizzas", name: "Fugazzeta", description: "Mozzarella, cebolla, queso sardo y olivas negras.", price: "$19.000" },
      ...
      { id: "pizza-peras", section: "pizzas", name: "Peras", description: "Mozzarella, peras, queso azul, tomillo y nueces.", price: "$20.000" },
      { id: "pizza-verdeo", section: "pizzas", name: "Verdeo y panceta", price: "$24.000" },
      { id: "pizza-cuatro-quesos", section: "pizzas", name: "Cuatro quesos", price: "$24.000" },
      ...
      { id: "ensalada-burrata", section: "ensaladas", name: "Ensalada de burrata", description: "Rúcula, burrata, pesto de perejil y menta, picles de cebolla, chutney de mango y nuez.", price: "$28.000" },
      ...
      { id: "ensalada-calabaza", section: "ensaladas", name: "Ensalada de calabaza y queso roquefort", description: "Mix de verdes, cebolla caramelizada, naranja, queso azul, nueces y sésamo.", price: "$22.000" },
    ],
  },
  {
    id: "bebidas",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "creme-brulee", name: "Crème brûlée", description: "Crema suave de vainilla con una capa de azúcar caramelizada.", price: "$10.000" },
      { id: "flan", name: "Flan casero", description: "Con crema, dulce de leche o mixto.", price: "$8.000" },
